    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-24">
        <div className="text-center">
          ...
          {/* Description */}
          <p className="max-w-3xl mx-auto text-base sm:text-lg text-gray-600 mb-12 leading-relaxed">
            A premier national-level project competition organized by the{' '}
            <span className="font-semibold text-gray-900">Department of Information Technology</span>{' '}
            at{' '}
            <span className="font-semibold text-gray-900">SSN College of Engineering</span>,
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16 w-full">
            ...
            <Link
              ...
              className="group flex items-center justify-center gap-3 px-8 py-4 bg-gradient-to-r from-[#0D4BA0] to-blue-700 rounded-xl hover:from-[#0a3d87] hover:to-blue-800 hover:shadow-md transition-colors duration-200 w-full sm:w-auto font-semibold text-white"
